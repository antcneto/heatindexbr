...
where homogeneous wind data are unavailable. Four synoptic hours were
selected (00h, 09h, 15h, and 21h local time, UTC-3) to capture the full
thermal cycle of a typical day: nocturnal minimum, morning warming,
afternoon peak, and evening cooling.
...
elevation model; ERA5 explains nearly all remaining variance after
...
neighbour station is -0.109 (non-significant). Prediction error does not
grow with distance.
